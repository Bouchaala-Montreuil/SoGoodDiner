...
window.SO_GOOD_I18N = {
  fr: {
    ...
    'adresse.options': 'Options véganes · Menu enfants',
    'adresse.optionsDetail': 'Signalés sur la fiche Google',
    ...
    'carte.vege': 'végé',
    'carte.halal': 'Viande 100 % halal',
    'game.btn': 'Jouer',
    'game.title': 'Empile le Burger',
    'game.tap': 'Tape, clique ou espace pour empiler',
    'game.score': 'Score',
    'game.best': 'Record',
    'game.over': 'Raté ! Le burger s’écroule.',
  ...
  en: {
    ...
    'adresse.options': 'Vegan options · Kids menu',
    'adresse.optionsDetail': 'Listed on the Google profile',
    ...
    'carte.vege': 'veg',
    'carte.halal': '100% halal meat',
    'game.btn': 'Play',
    'game.title': 'Stack the Burger',
    'game.tap': 'Tap, click or space to stack',
    'game.score': 'Score',
    'game.best': 'Best',
    'game.over': 'Missed! The burger topples.',
